...
function sayHello() { //as a default export can be only one item
...
// import * as info from './main'
// console.log(`The result is equal ${info.firstVar + info.secondVar}`);

console.log(`The result is equals to ${_main_js__WEBPACK_IMPORTED_MODULE_0__.firstVar + _main_js__WEBPACK_IMPORTED_MODULE_0__.secondVar}`);
